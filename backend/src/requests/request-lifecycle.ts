...
export const REQUEST_LIFECYCLE_COMPAT_STATUS: Record<string, RequestLifecycleState> = {
  ...
  client_confirmed: REQUEST_LIFECYCLE_STATES.CLIENT_CONFIRMED,
  reviewed: REQUEST_LIFECYCLE_STATES.REVIEWED,
...
export const REQUEST_LIFECYCLE_TRANSITIONS: Record<RequestLifecycleState, Partial<Record<RequestLifecycleAction, RequestLifecycleState>>> = {
  ...
  approved: {
    apply: REQUEST_LIFECYCLE_STATES.APPROVED,
    assign: REQUEST_LIFECYCLE_STATES.ASSIGNED,
    withdraw_application: REQUEST_LIFECYCLE_STATES.APPROVED,
    cancel: REQUEST_LIFECYCLE_STATES.CANCELED,
    hide: REQUEST_LIFECYCLE_STATES.HIDDEN,
  },
  assigned: {
    unassign: REQUEST_LIFECYCLE_STATES.APPROVED,
  ...
  waiting_client_confirmation: {
    confirm_completion: REQUEST_LIFECYCLE_STATES.CLIENT_CONFIRMED,
    dispute: REQUEST_LIFECYCLE_STATES.DISPUTED,
    hide: REQUEST_LIFECYCLE_STATES.HIDDEN,
  },
  client_confirmed: {
    leave_review: REQUEST_LIFECYCLE_STATES.REVIEWED,
    dispute: REQUEST_LIFECYCLE_STATES.DISPUTED,
    hide: REQUEST_LIFECYCLE_STATES.HIDDEN,
  },
  reviewed: {
    close: REQUEST_LIFECYCLE_STATES.COMPLETED,
    hide: REQUEST_LIFECYCLE_STATES.HIDDEN,
  },
  completed: {},
  rejected: {
